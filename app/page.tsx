...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-background">
      {/* Temporary homepage while components are disabled for deployment */}
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-4">
            <p className="text-lg font-medium">Site is being restored after deployment fixes</p>
            <p className="text-muted-foreground">Full functionality will be available soon.</p>
